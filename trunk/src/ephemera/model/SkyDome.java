...
public class SkyDome extends Node {
    ...
    public void setSunEnabled(boolean enable) {
        ...
        sun.getLight().setShadowCaster(true);
    ...
    private void setupLensFlare() {
        ...
        lightBox.setLightCombineMode(Spatial.LightCombineMode.CombineFirst);
        // Setup the lensflare textures.
        TextureState[] tex = new TextureState[4];
        tex[0] = DisplaySystem.getDisplaySystem().getRenderer().createTextureState();
        tex[0].setTexture(
                TextureManager.loadTexture(
                SkyDome.class.getClassLoader().getResource("ephemera/texture/objects/flare1.png"),
        ...
        tex[1].setTexture(
                TextureManager.loadTexture(
                		SkyDome.class.getClassLoader().getResource("ephemera/texture/objects/flare2.png"),
        ...
        tex[2].setTexture(
                TextureManager.loadTexture(
                SkyDome.class.getClassLoader().getResource("ephemera/texture/objects/flare3.png"),
                Texture.MinificationFilter.Trilinear,
                Texture.MagnificationFilter.Bilinear));
        ...
        tex[3].setTexture(
                TextureManager.loadTexture(
                		SkyDome.class.getClassLoader().getResource("ephemera/texture/objects/flare4.png"),
                Texture.MinificationFilter.Trilinear,
                Texture.MagnificationFilter.Bilinear));
        ...
        flare.setIntensity(0.25f);
 
        flare.setModelBound(new BoundingBox());
        flare.setCullHint(CullHint.Dynamic);
