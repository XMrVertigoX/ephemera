...
public class swarmGUI extends JFrame {
    ...
    private JPanel createOptionsPanel() {
        ...
        JLabel cohLabel = new JLabel("Koh�sion");
   	...
   	// 	countSlider.setMinorTickSpacing(250);
        ...
        JButton addFlyButton = new JButton(new AbstractAction("Eine Fliege hinzuf�gen"){
        	private static final long serialVersionUID = 1L;
    ...
    private JPanel createAdditionalPanel() {
        ...
        JLabel desiredLabel = new JLabel("Gew�nschter Abstand");
        desiredLabel.setForeground(white);
        JLabel neighborLabel = new JLabel ("Abstand zum Nachbarn");
        neighborLabel.setForeground(white);
        
        //Kot hinzuf�gen-Button
        JButton shitButton = new JButton(new AbstractAction("Kot hinzuf�gen") {
            private static final long serialVersionUID = 1L;
