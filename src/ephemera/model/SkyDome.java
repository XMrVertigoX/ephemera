...
public class SkyDome extends Node {
    ...
    private void setupLensFlare() {
        ...
        tex[0].setTexture(
                ...
                SkyDome.class.getClassLoader().getResource("ephemera/ObjTextures/flare1.png"),
        ...
        tex[1].setTexture(
                TextureManager.loadTexture(
                SkyDome.class.getClassLoader().getResource("ephemera/ObjTextures/flare2.png"),
                Texture.MinificationFilter.Trilinear,
                Texture.MagnificationFilter.Bilinear));
        ...
        tex[2].setTexture(
                TextureManager.loadTexture(
                SkyDome.class.getClassLoader().getResource("ephemera/ObjTextures/flare3.png"),//.locateResource(ResourceLocatorTool.TYPE_TEXTURE, "ephemera/ObjTextures/flare3.png"),
                Texture.MinificationFilter.Trilinear,
                Texture.MagnificationFilter.Bilinear));
        ...
        tex[3].setTexture(
                TextureManager.loadTexture(
                SkyDome.class.getClassLoader().getResource("ephemera/ObjTextures/flare4.png"),
                Texture.MinificationFilter.Trilinear,
                Texture.MagnificationFilter.Bilinear));
